...
public class DiscogsAuthorization {
    ...
    public OAuth1RequestToken redirectAuthorization() {
        try {
    ...
    public void getAuthorization(String verifier, OAuth1RequestToken requestToken) throws IOException, ExecutionException, InterruptedException {
    ...
    public boolean verifyAccess() throws IOException, ExecutionException, InterruptedException {
