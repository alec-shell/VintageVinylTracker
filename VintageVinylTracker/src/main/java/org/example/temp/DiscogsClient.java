...
public class DiscogsClient {
    ...
    public static String searchQuery(DiscogsAuthorization auth, String album, String artist, String year, String catNo, int pageNo) throws IOException, ExecutionException, InterruptedException {
    ...
    public static String getPriceSuggestions(DiscogsAuthorization auth, int id) throws IOException, ExecutionException, InterruptedException {
        StringBuilder query = new StringBuilder();
